...
Reference full template: `/Users/vinit/Tars/Development/exp/cx-agent-evals--oracle/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/vinit/Tars/Development/exp/cx-agent-evals--oracle/.claude/get-shit-done/templates/state.md`.
