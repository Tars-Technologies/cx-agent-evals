# Internal docs (historical / non-authoritative)

This directory holds internal planning and design artifacts produced during
development. They are kept for context and history, **not** as authoritative
documentation.

> ⚠️ These documents may be outdated, speculative, or describe approaches that
> were never shipped. For accurate, current information start from the root
