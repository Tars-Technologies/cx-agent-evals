...
and runs on every push to `main`. For the full release mechanics and versioning
policy (patch vs. minor, why major isn't used yet), see
[packages/eval-lib/releasing-eval-lib.md](./packages/eval-lib/releasing-eval-lib.md).
...
1. While changing `packages/eval-lib`, add a changeset (`pnpm changeset`, or write
   ...
   generated file in `.changeset/`. See [packages/eval-lib/releasing-eval-lib.md](./packages/eval-lib/releasing-eval-lib.md).
