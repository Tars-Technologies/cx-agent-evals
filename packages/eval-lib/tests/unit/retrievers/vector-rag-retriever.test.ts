...
describe("VectorRAGRetriever", () => {
  ...
  describe("init", () => {
    it("should chunk corpus and add to vector store", async () => {
      ...
      expect(mockChunker.chunkWithPositions).toHaveBeenCalledWith(
        corpus.documents[0]
      )
