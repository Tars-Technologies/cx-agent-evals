...
describe("computeIndexConfigHash — new strategies", () => {
  it("produces different hashes for different strategies", () => {
    ...
    const contextual: PipelineConfig = {
      name: "b",
      index: { strategy: "contextual" }
    }
    const summary: PipelineConfig = {
      name: "c",
      index: { strategy: "summary" }
    }
    const parentChild: PipelineConfig = {
      name: "d",
  ...
  it("concurrency does NOT affect contextual index hash", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "contextual", concurrency: 5 }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "contextual", concurrency: 20 }
    }
  ...
  it("concurrency does NOT affect summary index hash", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "summary", concurrency: 5 }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "summary", concurrency: 20 }
    }
  ...
  it("contextPrompt affects contextual index hash", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "contextual", contextPrompt: "prompt A" }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "contextual", contextPrompt: "prompt B" }
    }
  ...
  it("summaryPrompt affects summary index hash", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "summary", summaryPrompt: "prompt A" }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "summary", summaryPrompt: "prompt B" }
    }
  ...
  it("childChunkSize affects parent-child index hash", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "parent-child", childChunkSize: 100 }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "parent-child", childChunkSize: 300 }
    }
  ...
  it("parentChunkSize affects parent-child index hash", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "parent-child", parentChunkSize: 500 }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "parent-child", parentChunkSize: 2000 }
    }
  ...
  it("stable across identical contextual configs", () => {
    const a: PipelineConfig = {
      name: "a",
      index: { strategy: "contextual", chunkSize: 500 }
    }
    const b: PipelineConfig = {
      name: "b",
      index: { strategy: "contextual", chunkSize: 500 }
...
describe("computeRetrieverConfigHash — new index strategies", () => {
  it("produces different hashes for different index strategies (same other stages)", () => {
    const base = {
      query: { strategy: "identity" as const },
      search: { strategy: "dense" as const }
    }
    const plain: PipelineConfig = {
      name: "a",
