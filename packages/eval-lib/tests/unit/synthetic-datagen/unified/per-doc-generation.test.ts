...
describe("buildPrompt — Scenario 4", () => {
  const docContent =
    "This document explains basic networking concepts including TCP/IP."
...
describe("buildPrompt — Scenario 2", () => {
  ...
  const combos: Record<string, string>[] = [
    { persona: "architect", intent: "design" }
  ]
...
describe("buildPrompt — Scenario 1", () => {
  const docContent =
    "Container orchestration manages deployment of containers at scale."
      ...
      questions: [
        {
          ...
          citation: "Kubernetes manages containers",
          source: "generated",
          profile: null
        },
        {
          question: "How do pods work?",
          citation: "Pods are the smallest units",
          source: "direct-reuse",
          profile: "persona=developer"
        }
      ]
    })
    ...
    const directReuseClient = {
      ...
      async complete() {
        return JSON.stringify({
          questions: [
            {
              question: "Real question 1?",
              citation: "Passage 1",
              source: "direct-reuse",
              profile: null
            },
            {
              question: "Real question 2?",
              citation: "Passage 2",
              source: "direct-reuse",
              profile: null
            }
