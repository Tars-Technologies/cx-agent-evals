...
export function WizardStepPreferences({
  preferences,
  onChange,
  onNext,
  onBack
}: WizardStepPreferencesProps) {
    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            onChange({ ...preferences, focusAreas: e.target.value })
          }
      ...
      <div className="flex justify-between">
        ...
        <button
          onClick={onNext}
          className="px-3 py-1.5 text-xs rounded bg-accent-dim text-accent-bright hover:bg-accent/20 transition-colors"
        >
          Next →
        </button>
      </div>
