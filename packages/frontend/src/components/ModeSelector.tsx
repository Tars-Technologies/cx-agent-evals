        ...
        <div className="max-w-6xl xl:max-w-[1400px] w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
            ...
            >
              ...
              <p className="text-text-muted text-sm leading-relaxed">
                Create and curate evaluation datasets with ground truth spans
            ...
            >
              ...
              <p className="text-text-muted text-sm leading-relaxed">
                Create CX agents with custom prompts and retriever tools. Test
                them in a live playground.
              </p>
              <div className="mt-6 text-xs text-text-dim flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              <p className="text-text-muted text-sm leading-relaxed">
                Build LLM-as-Judge evaluators from human annotations. Validate
                on dev/test sets and run on full experiments.
              </p>
              <div className="mt-6 text-xs text-text-dim flex items-center gap-2 flex-wrap">
