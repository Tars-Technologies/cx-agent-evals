...
function MetricRow({ label, value }: { label: string; value: number }) {
  return (
    <div className="flex justify-between items-center gap-2">
      ...
      <span
        style={{ fontSize: "11px" }}
        className="text-text-dim font-medium tabular-nums"
      >
        {(value * 100).toFixed(1)}%
      </span>
    </div>
    ...
    <div className="flex flex-col items-stretch" style={{ flex: "0 0 160px" }}>
      ...
      <div
        style={{
          height: "72px",
          background:
            "linear-gradient(180deg, rgba(110,231,183,0.2) 0%, rgba(110,231,183,0.05) 100%)",
          border: "1px solid rgba(110,231,183,0.3)",
          borderTop: "none"
        }}
      />
    ...
    <div className="flex flex-col items-stretch" style={{ flex: "0 0 140px" }}>
      ...
      <div
        style={{
          height: "52px",
          background:
            "linear-gradient(180deg, rgba(148,163,184,0.15) 0%, rgba(148,163,184,0.04) 100%)",
          border: "1px solid rgba(148,163,184,0.2)",
          borderTop: "none"
        }}
      />
    ...
    <div className="flex flex-col items-stretch" style={{ flex: "0 0 140px" }}>
      ...
      <div
        style={{
          height: "36px",
          background:
            "linear-gradient(180deg, rgba(217,119,6,0.15) 0%, rgba(217,119,6,0.04) 100%)",
          border: "1px solid rgba(217,119,6,0.2)",
          borderTop: "none"
        }}
      />
